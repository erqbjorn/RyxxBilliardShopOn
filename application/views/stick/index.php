<body>
	<div class="container">
		<h1 class="text-center text-white">Stick</h1>	
			...
			<div class="col-md-6">
				<form action="" method="post">
					<div class="input-group">
						<input type="text" class="form-control" placeholder="cari stick..." name="keyword">
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <form action="<?= base_url('stick') ?>" method="post">
			        <div class="form group">
			        	<label for="nama">Stick</label>
			        	<input type="numeric" name="nama" class="form-control" id="nama" placeholder="Masukan Stick">
				</div>
				...
				<div class="col-md-4 mb-4">
					<div class="card bg-secondary text-white" style="width: 100%;">
						...
						<div class="card-body">
							...
							<h6 class="card-text">Rp. <?= $S['harga']; ?></h6>	
							<a href="<?= base_url(); ?>stick/hapus/<?= $S['id']; ?>" class="badge bg-danger float-end" onclick="return confirm('Anda yakin?');">Hapus</a>
...
<!-- awal modal edit -->
<?php $no = 0 ; foreach ($stick as $S): $no++; ?>
    <div class="modal fade" id="editModal<?=$S['id'];?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
              <?=form_open_multipart('stick/ubah'); ?>
